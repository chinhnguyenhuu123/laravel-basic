            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    <div class="blog-title-area text-center">
                        ...
                        <span class="color-orange"><a href="tech-category-01.html" title="">{{ $posts->category->name }}</a></span>
                    ...
                    <div class="single-post-media">
                        <img src="{{ "/" . $posts->showimage() }}" alt="" class="img-fluid">
                    </div><!-- end media -->
                    ...
                    <div class="custombox clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form-wrapper" action="{{ route('wed.comment',$posts->slug) }}" method="POST">
                                    @csrf
